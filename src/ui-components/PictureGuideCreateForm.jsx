...
import { createPictureGuide } from "../graphql/mutations";
const client = generateClient();
export default function PictureGuideCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createPictureGuide.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PictureGuideCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
